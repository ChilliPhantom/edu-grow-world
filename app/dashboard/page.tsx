  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-md px-6 py-4 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-blue-700">EduGrow SA</h1>
        <nav className="flex items-center gap-6">
          <span className="text-gray-600">Sunshine Nursery School</span>
          <a href="/profile" className="text-gray-700 hover:underline">Profile</a>
          <a href="/logout" className="text-red-600 font-semibold hover:underline">Logout</a>
        </nav>
      </header>
      <main className="max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow space-y-8">
